    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 flex flex-col items-center">
        ...
        <motion.p
          ...
          className="text-5xl md:text-6xl lg:text-7xl font-heading font-bold text-secondary leading-none mb-10 drop-shadow-[0_0_30px_hsl(var(--secondary)/0.7)] [text-shadow:0_0_40px_hsl(var(--secondary)/0.5),0_0_80px_hsl(var(--secondary)/0.25)]"
        >
        ...
        >
          <Button
            variant="premium"
            size="lg"
            className="px-16 py-7 text-sm shadow-[0_0_20px_hsl(var(--secondary)/0.4),0_0_50px_hsl(var(--secondary)/0.3),0_0_100px_hsl(var(--secondary)/0.15)] hover:shadow-[0_0_30px_hsl(var(--secondary)/0.6),0_0_70px_hsl(var(--secondary)/0.4),0_0_120px_hsl(var(--secondary)/0.2)] transition-shadow duration-500"
